    ...
    <section className="bi-page-right-wrapper home-page">
                ...
                <div className="left-side">
                  ...
                  <span className="bi-post-react-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                      <circle cx="9.76981" cy="9.76663" r="8.98856" stroke="#B3BAC5" strokeWidth="1.5"
                        strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M16.0234 16.4851L19.5475 20" stroke="#B3BAC5" strokeWidth="1.5" strokeLinecap="round"
                ...
                <a href="#" className="bi-group-list-item-link">
                  ...
                  <div className="bi-group-list-item-text">
                    ...
                    <span className="bi-group-member">
                      <span className="bi-msg-text">Lorem ipsum dolor sit amet, consectetur Lorem ipsum
                        dolor sit amet consectetur adipisicing elit. Libero
                        necessitatibus iusto, qui minus debitis deserunt,
                        accusamus omnis corporis quos iure ab itaque
                        perspiciatis autem ducimus incidunt, officiis quam
              ...
              <li className="bi-group-list-item">
                <a href="#" className="bi-group-list-item-link">
                  ...
                  <div className="bi-group-list-item-text">
                    ...
                    <span className="bi-group-member">
                      <span className="bi-msg-text">Lorem ipsum dolor sit amet, consectetur...</span>
                      <span>14:25</span>
                    </span>
                  </div>
                </a>
        ...
        <div className="common-side-opener bi-right-side-opener">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M15.75 19.5L8.25 12L15.75 4.5" stroke="black" strokeWidth="1.5" strokeLinecap="round"
              strokeLinejoin="round" />
          </svg>
        </div>
