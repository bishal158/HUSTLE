...
const Posts = () => {
  ...
  if (isPostsLoading || isFilteredPostsLoading) return <p>Loading...</p>;
  if (postsError || filteredPostsError)
    return <p>Error: {postsError?.message || filteredPostsError?.message}</p>;
              ...
              <div className="bi-post-header">
                <div className="bi-post-header-left">
                  <span className="bi-post-user-img">
                    <img src={post.posted_by_image} alt={post.posted_by} />
                  </span>
